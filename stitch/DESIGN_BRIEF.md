...
- PulseRail Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called PulseRail Lite. It should be a full-viewport reflex arcade game where the player routes energy pulses through switching rail junctions, dodges overload zones, opens a settings overlay, saves preferences, pauses/resumes, and shows score, combo, lives, and level. Keep it pol…
...
- Gameplay - PulseRail Lite
- Game Settings - PulseRail Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - PulseRail Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - PulseRail Lite
